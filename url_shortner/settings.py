...
# To set the model that we developed for the authentication
...
EMAIL_FROM = 'sakardahal1234@gmail.com'
EMAIL_HOST_USER = 'sakardahal1234@gmail.com'
EMAIL_HOST_PASSWORD = 'mpmlrpggrikeksji'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
